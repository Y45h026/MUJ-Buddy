...
const homeStyles = `
  ...
  .home-logo {
    ...
    letter-spacing: 0.18em; text-transform: uppercase; color: #4ecba0; margin-bottom: 0.5rem;
  }
  .home-title {
    font-family: 'Syne', sans-serif; font-size: clamp(2rem, 4vw, 3.2rem);
    font-weight: 700; color: #f0ebe0; line-height: 1.1;
  }
  ...
  .grid {
    ...
    gap: 1.25rem; padding: 2.5rem 2.5rem 0;
    max-width: 1300px; margin: 0 auto;
  }
  ...
  .prof-avatar {
    ...
    background: rgba(78,203,160,0.12); border: 1px solid rgba(78,203,160,0.2);
    display: flex; align-items: center; justify-content: center;
    font-family: 'Syne', sans-serif; font-size: 0.85rem; font-weight: 700;
    color: #4ecba0; margin-bottom: 1rem; letter-spacing: 0.05em;
  }
  ...
  .admin-trigger {
    font-size: 0.72rem; color: rgba(232,228,220,0.15);
  ...
  .loading-state {
    ...
    text-transform: uppercase; color: rgba(232,228,220,0.25);
  }
    ...
    <>
      ...
      <div className="home-root">
        ...
        <div className="home-footer">
          <button className="admin-trigger" onClick={() => setShowModal(true)}>
            admin access
          </button>
        </div>
      </div>
